...
class yadisk_backup_connector(osv.osv):
    ...
    _columns = {
        ...
        'yadisk_odoo_connector_id': fields.many2one('yadisk.odoo.connector', 'Id', select=True, required=True),
        'db_backup_action_id': fields.many2one('db.backup.action', 'Id', select=True),
